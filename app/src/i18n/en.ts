...
export const en = {
  ...
  portfolio: {
    ...
    intro: 'The build side of Artetecha. Websites and web applications, from the first idea to a working product — with design, architecture, and delivery in the same hands.',
