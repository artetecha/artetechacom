...
export const it = {
  ...
  portfolio: {
    ...
    intro: 'Siti e applicazioni web realizzati con Artetecha, insieme a una selezione dei miei contributi tecnici durante precedenti incarichi di consulenza e lavoro dipendente. Ogni progetto descrive il mio ruolo e il lavoro svolto.',
    historyTitle: 'Progetti tecnici del passato',
    historyIntro: 'Una selezione di progetti di squadra svolti con Artetecha Ltd e come dipendente, presentati nel loro contesto originale.',
    historical: 'Progetto storico',
    caseStudy: 'Caso studio tecnico',
    historicCommission: 'Artetecha Ltd · Contributo al team',
    employment: 'Lavoro dipendente · Contributo al team',
